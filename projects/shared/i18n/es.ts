export const sharedTranslations = {
  more: {
    account: 'Mi cuenta',
    clubServices: 'Servicios del club',
    clubSettings: 'Configuración del club',
    leaveGuest: 'Salir del modo invitado'
  },
  primeng: {
    apply: 'Aplicar',
    clear: 'Limpiar',
  ...
  admin: {
    ...
    settingsForms: {
      ...
      duplicateSuccess: '¡Formulario duplicado correctamente!',
      duplicateError: 'No se pudo duplicar el formulario. Inténtalo de nuevo.',
      actionsMenu: 'Más opciones',
      remove: 'Eliminar',
      removeConfirmTitle: 'Eliminar formulario',
      removeConfirmMessage: '"{name}" se eliminará de la lista de forma permanente. Esta acción no se puede deshacer.',
      removeSuccess: 'Formulario eliminado.',
      removeError: 'No se pudo eliminar el formulario. Inténtalo de nuevo.',
      status: {
        AC: 'Activo',
        I: 'Inactivo',
        E: 'Caducado',
