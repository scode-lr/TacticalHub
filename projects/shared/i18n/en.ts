export const sharedTranslations = {
  ...
  admin: {
    ...
    settingsForms: {
      ...
      duplicateSuccess: 'Form duplicated successfully!',
      duplicateError: 'Could not duplicate form. Please try again.',
      actionsMenu: 'More options',
      remove: 'Delete',
      removeConfirmTitle: 'Delete form',
      removeConfirmMessage: '"{name}" will be permanently removed from the list. This cannot be undone.',
      removeSuccess: 'Form deleted.',
      removeError: 'Could not delete form. Please try again.',
      status: {
        AC: 'Active',
        I: 'Inactive',
        E: 'Expired',
